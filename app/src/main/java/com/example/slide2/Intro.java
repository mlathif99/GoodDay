...
public class Intro extends AppCompatActivity {
    ...
    private String[] title_array = {
            "Mode Developer", "Fake GPS",
            "Face Detection", "Technology",
            "History","Utility"
    };
    private String[] description_array = {
            "Pengembangan Aplikasi GoodDay", "GoodDay Tidak dapat menggunakan Fitur Fake GPS",
            "Wajah tidak sesuai data,GoodDay tidak dapat menerima", "Penggunaan teknologi untuk menunjang GoodDay",
            "Seluruh riwayat pengguna tersimpan pada sistem GoodDay","GoodDay akan terus dikembangkan dengan tingkat kompleksitas yang tinggi "
    };
